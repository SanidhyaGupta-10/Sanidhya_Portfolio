...
const techStack: TechStack[] = [
  ...
  { category: "Animations", items: ["GSAP", "React-Three-Fiber(R3F)", "Motion"] },
  { category: "Mobile", items: ["React Native", "Expo"] },
  { category: "Styling", items: ["Tailwind CSS", "CSS"] },
  { category: "Backend", items: ["Node.js", "Express"] },
  { category: "Database", items: ["MongoDB", "PostgreSQL"] },
  { category: "Dev Tools", items: ["Git", "GitHub", "Vercel", "Docker"] },
];
      ...
      children: [
        {
          ...
          description: ["iNSpix - HD Free Photos, Videos and GIFs"],
        },
        {
          id: 2,
          name: "iNSpix.com",
